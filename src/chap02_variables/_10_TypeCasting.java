...
public class _10_TypeCasting {
	public static void main(String[] args) {
		...
		// 3. 강제형변환1 : byte 크기가 큰 타이벵서 작은 타입으로 변환할 때는 타입을 명시해줘야 한다.
		int iNum2 = 60;
		...
		// 5.  연산에서의 형변환
		// 형변환순서에 따라서 연산 중에 byte 크기가 더 큰 타입이나 좀 더 세밀한 표현범위를 갖는 타입으로 자동 형 변환이 일어난다.
		...
		// 6. 문자열 결합 연산
		// 문자열 결합 연산에서는 모든 타입이 문자열로 변환된 후 문자열과 결합한다.
		String str = "bitcamp";
		int classRoom = 502;
